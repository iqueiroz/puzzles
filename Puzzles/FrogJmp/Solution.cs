...
X and wants to get to a position greater than or equal to Y. The small frog always jumps a fixed
distance, D.
...
namespace Puzzles.FrogJmp
{
    ...
    public class Solution
    {
        public int solution(int X, int Y, int D)
        {
            ...
            return Convert.ToInt32(Math.Ceiling(distance / Convert.ToDouble(D)));
        }
    }
}
